Program Pzim ;
var
notas100,notas50,notas20,notas10,notas5,notas2,notas1,dinheiro: integer;
moeda050,moeda025,moeda010,moeda05,moeda01,moeda:real;
Begin
  readln(dinheiro);
  moeda := dinheiro;
  
while(dinheiro<>0)and(moeda <>0) do  
					  ...
					  begin
					    ...
					    dinheiro := dinheiro mod 2;
					  	...
					  	begin
					  		...
					  		if ((moeda / frac(50)) <> 0)then
					  			moeda050 := moeda050+(moeda / frac(50));
								moeda := moeda / frac(50); 						  					  
